...
class DirectoryDataCache implements DataCache
{
     ...
     *
     * `$cacheName` will be used as a prefix for all files generated by the cache.
     *
     ...
     */
    public function __construct(string $directoryPath, string $cacheName, string $fileExtension = 'txt', bool $alwaysUseKeyHashes = false)
    {
    ...
    private function getFilePathForKey(string $key, string $expires): string
    {
        ...
        return "$this->cachePath/$this->cacheName-$actualKey-$expires.$this->fileExtension";
    }

    private function getAllFilePathsInCache(): array {
        return glob("$this->cachePath/$this->cacheName-*.$this->fileExtension");
    }
